...
def welcome():
    ...
    return"""<html>
    <h1>Welcome to your Hawaiian vacation trip planner!</h1>
    <ul>
    <br>
    <li>
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <a href="/api/v1.0/2016-08-23">/api/v1.0/2016-08-23</a>
    </li>
    <br>
    <li>
    Return a JSON list of tmin, tmax, tavg for the dates in range of start date and end date inclusive:
    <a href="/api/v1.0/2016-08-15/2017-08-23">/api/v1.0/2016-08-15/2016-08-23</a>
    </li>
    <br>
    </ul>
    </html>
